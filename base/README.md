...
| DB_MYSQL_HOST        | /db/mysql/host      | mariadb    | The database host if DB_DRIVER is `mysql`                                                       |
| DB_MYSQL_PORT        | /db/mysql/port      | 3306       | The database port if DB_DRIVER is `mysql`                                                       |
...
| DB_POSTGRESQL_HOST   | /db/postgresql/host | postgresql | The database host if DB_DRIVER is `postgresql`                                                  |
| DB_POSTGRESQL_PORT   | /db/postgresql/port | 5432       | The database port if DB_DRIVER is `postgresql`                                                  |
