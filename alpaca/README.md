...
| ALPACA_DLQ                                 | -                                          | broker:queue:ActiveMQ.DLQ                            | Camel endpoint designating the dead letter queue for undeliverable messages.  Any undeliverable message is routed to this endpoint. | 
