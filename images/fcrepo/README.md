...
Built from [Islandora-DevOps/isle-buildkit fcrepo](https://github.com/Islandora-DevOps/isle-buildkit/tree/main/images/fcrepo)
...
```bash
FCREPO_VERSION=$(cat fcrepo/Dockerfile | grep -o 'FCREPO_VERSION=.*' | cut -f2 -d=)
FCREPO_FILE=$(cat fcrepo/Dockerfile | grep -o 'FCREPO_FILE=.*' | cut -f2 -d=)
FCREPO_URL=$(cat fcrepo/Dockerfile | grep -o 'FCREPO_URL=.*' | cut -f2 -d=)
...
```bash
IMPORT_EXPORT_VERSION=$(cat fcrepo/Dockerfile | grep -o 'IMPORT_EXPORT_VERSION=.*' | cut -f2 -d=)
IMPORT_EXPORT_FILE=$(cat fcrepo/Dockerfile | grep -o 'IMPORT_EXPORT_FILE=.*' | cut -f2 -d=)
IMPORT_EXPORT_URL=$(cat fcrepo/Dockerfile | grep -o 'IMPORT_EXPORT_URL=.*' | cut -f2 -d=)
...
```bash
UPGRADE_UTILS_VERSION=$(cat fcrepo/Dockerfile | grep -o 'UPGRADE_UTILS_VERSION=.*' | cut -f2 -d=)
UPGRADE_UTILS_FILE=$(cat fcrepo/Dockerfile | grep -o 'UPGRADE_UTILS_FILE=.*' | cut -f2 -d=)
UPGRADE_UTILS_URL=$(cat fcrepo/Dockerfile | grep -o 'UPGRADE_UTILS_URL=.*' | cut -f2 -d=)
